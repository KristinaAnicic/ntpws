...
<body>
	...
	if (!empty($_COOKIE['news_title_1']) || !empty($_COOKIE['news_title_2']) || !empty($_COOKIE['news_title_3'])) {
		...
		if(isset($_COOKIE['news_title_1'])){
			print '<li style="border-bottom: solid 1px white"><a href="'. $_COOKIE['link_1'] .'">' . $_COOKIE['news_title_1'] . '</a></li>';
		}
		if(isset($_COOKIE['news_title_2'])){
			print '<li style="border-bottom: solid 1px white"><a href="'. $_COOKIE['link_2'] .'">' . $_COOKIE['news_title_2'] . '</a></li>';
		}
		if(isset($_COOKIE['news_title_3'])){
			print '<li style="border-bottom: solid 1px white"><a href="'. $_COOKIE['link_3'] .'">' . $_COOKIE['news_title_3'] . '</a></li>';
		}
		print '
		</ul>
		</aside>';
