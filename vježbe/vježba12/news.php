<?php 
	...
	if (!isset($action)) {
		...
		if ($action == 1) {
			...
			setcookie('link_1', 'index.php?menu='.$menu.'&action='. $action, time() + (86400 * 30));
			print '
			...
			setcookie('link_2', 'index.php?menu='. $menu.'&action='. $action, time() + (86400 * 30));
			print '
			...
			setcookie('link_3', 'index.php?menu='.$menu.'&action='. $action, time() + (86400 * 30));
			print '
