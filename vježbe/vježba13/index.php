...
<body>
	...
	if (!empty($_SESSION['news_title_1']) || !empty($_SESSION['news_title_2']) || !empty($_SESSION['news_title_3'])) {
		...
		if(isset($_SESSION['news_title_1'])){
			print '<li style="border-bottom: solid 1px white"><a href="' . $_SESSION['link_1'] .'">' . $_SESSION['news_title_1'] . '</a></li>';
		}
		if(isset($_SESSION['news_title_2'])){
			print '<li style="border-bottom: solid 1px white"><a href="' . $_SESSION['link_2'] .'">' . $_SESSION['news_title_2'] . '</a></li>';
		}
		if(isset($_SESSION['news_title_3'])){
			print '<li style="border-bottom: solid 1px white"><a href="' . $_SESSION['link_3'] .'">' . $_SESSION['news_title_3'] . '</a></li>';
		}
		print '
		</ul>
		<p><a href="delete-session.php">Obriši zadnje pregledano</a></p>
		</aside>';
	}
	print '
	<footer>
