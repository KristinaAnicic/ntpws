<?php
    print'
    <!--<h1>Contact Form</h1>-->
    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2781.017721822781!2d16.038958512220315!3d45.81090347096107!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x4766790020667469%3A0xa9a20d6e234405b1!2sTehni%C4%8Dko%20veleu%C4%8Dili%C5%A1te%20u%20Zagrebu%20(TVZ)%20-%20INRO!5e0!3m2!1shr!2shr!4v1731029495647!5m2!1shr!2shr" width="100%" height="250" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
    </br></br>
    <div class="container">
        <form method="post" action="" class="contact-form col-lg-8">
            ...
            <select name="country" id="country" required class="form-control-plaintext contact-input">
                <option value="" disabled selected class="contact-input">Please select</option>
                <option value="HR" class="contact-option">Croatia</option>
                <option value="DE" class="contact-option">Germany</option>
                <option value="IT" class="contact-option">Italy</option>
                <option value="FR" class="contact-option">France</option>
                <option value="ESP" class="contact-option">Spain</option>
            </select></br>
